        ...
        <div className="Contact w-full flex justify-between items-center mt-40 mb-40 mainFont">
            <div className="w-[673px] h-full flex flex-col justify-between items-start ">
                ...
                <span className=" font-medium text-xl text-[#979797] leading-8">
                    Agar sizda format haqida savollaringiz bo&apos;lsa yoki
                    nimani tanlashni bilmasangiz, raqamingizni qoldiring va
                    operatorlarimiz sizga qayta qo&apos;ng&apos;iroq qilishadi.
                </span>
            </div>
