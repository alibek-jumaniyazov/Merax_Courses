...
import { TContact, TForm } from "@/context/PagesInfoTypes/PagesInfoTypes";

type Props = {
  item: TContact;
};

export default function ContactCourse({ item }: Props) {
  ...
  return (
    <div
      id="contact-course"
      className="Contact w-full flex justify-between items-center mt-40 mb-40 mainFont"
    >
      <div className="flex flex-col justify-center items-start gap-5">
        <p className="font-semibold text-5xl text-textColor">{item.title}</p>
